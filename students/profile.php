    ...
    <div class="main-container">
        <div class="navbar">
            ...
            <div class="dropbtn2">  
                ...
                <div class="name"><?php echo $_COOKIE['uid']; ?></div>
                <i class="ddown2"></i>
            </div>
            <div class="dropdown-content2">
                <a href="logoutAccount.php" class="icon2"><img src="media/logout.png"> Logout </a>
            </div>
            </div>
        </div>
            ...
            <div class="profile-contents">
                <div class="pfp-container">
                    ...
                    <div class="important-info">
                        <p id="fullName"><?php echo $_COOKIE['fullName']; ?></p>
                        <p id="idNumber"><?php echo $_COOKIE['uid']; ?></p>
                        <p id="course"><?php echo $_COOKIE['coursedisp']; ?></p>
                    </div>
                </div>
                <div id="table-profile">
                    <div class="row">
                        <p class="title-info">Sex:</p>
                        <p class="info" id="sex"><?php echo $_COOKIE['sex']; ?></p>
                        <p class="title-info">Birthdate:</p>
                        <p class="info" id="birthdate"><?php echo $_COOKIE['birthdate']; ?></p>
                        <p class="title-info">Address</p>
                        <p class="info" id="address"><?php echo $_COOKIE['address']; ?></p>
                    </div>
                    <div class="row">
                        <p class="title-info">Contact Number: </p>
                        <p class="info" id="cNumber"><?php echo $_COOKIE['cNumber']; ?></p>
                        <p class="title-info">Email: </p>
                        <p class="info" id="email"><?php echo $_COOKIE['email']; ?></p>
                    </div>
